...
public class Polymorphism {
    ...
    -you can not methods that dont exist in parent class
    ...
    -objet type decides which implementation of the method to be execured when the method is called
    ...
    example:
        ...
        boolean isSquare = shape1 isntanceof Square; --> false
